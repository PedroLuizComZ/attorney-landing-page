...
const ServiceArea = ({ className = "", title, subTitle }: any) => {
  return (
    <Parallax contentClassName={`ourServiceArea ${className}`} strength={200}>
      ...
      <Grid item xs={12}>
        <p className={"cookies-message"} >Nosso website não faz uso de cookies. O tratamento de dados pessoais, na prestação de serviços, se faz em adequação à Lei 13.709/2018 (LGPD).</p>
      </Grid>
    </Parallax>
  );
};
